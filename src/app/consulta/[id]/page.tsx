    ...
    <>
      ...
      <main className="flex min-h-screen flex-row items-center justify-between p-24">
        ...
        <div className="flex flex-col items-center">
          <h1 className="text-xl font-bold">PANORAMA DA LOCALIDADE</h1>
          <div className="mb-8">
            <CompanyStatusChart
              size="sm"
              customTitle={`EMPRESAS DE ${mainActivityNeighborhood.toUpperCase()} ABERTAS E FECHADAS EM ${neighborhood.name.toUpperCase()}`}
            />
          </div>
          <div
